...
if __name__ == "__main__":
    ...
    #---------------------------------------------------------------------#
    classes_path    = '/home/z004f4fy/myproject/yolo3/model_data/defect_classes.txt'
    #---------------------------------------------------------------------#
    #   anchors_path    代表先验框对应的txt文件，一般不修改。
    #   anchors_mask    用于帮助代码找到对应的先验框，一般不修改。
    #---------------------------------------------------------------------#
    anchors_path    = '/home/z004f4fy/myproject/yolo3/model_data/yolo_anchors.txt'
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    #model_path      = '/home/z004f4fy/myproject/yolo3/model_data/yolo_weights.pth'
    model_path      = '/home/z004f4fy/myproject/yolo3/logs/best_epoch_weights.pth'
    #------------------------------------------------------#
